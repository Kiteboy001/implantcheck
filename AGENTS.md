...
- **Case** — id, submitter_id, tier (BASIC/STANDARD/COMPLEX/PILOT_GUIDE), status (PENDING→UNDER_REVIEW→APPROVED/NEEDS_REVISION), patient_context, treatment_notes, software_used
...
- **Pricing:** Basic Check £95 (single implant), Standard £199 (2–4 implants with plan), Complex £295 (4+ implants + Zoom call), Pilot Guide £399 (collaborative surgical guide). Hardcoded v1, Stripe in v2.
