...
export default function NewCaseForm({ reviewers }: { reviewers: Reviewer[] }) {
        ...
        {hasReviewers && (
          <div className="bg-white rounded-xl border border-gray-100 p-6">
            ...
            <div className="grid gap-2">
              <label className={`flex items-center gap-4 p-3 rounded-lg border-2 cursor-pointer transition-all ${selectedReviewer === "" ? "border-gray-200 bg-gray-50" : "border-gray-100 hover:border-gray-200"}`}>
                <input
                  type="radio"
                  name="reviewerId"
                  value=""
              ...
              {reviewers.map((r) => (
                <label key={r.id} className={`flex items-center gap-4 p-3 rounded-lg border-2 cursor-pointer transition-all ${selectedReviewer === r.id ? "border-gold bg-gold/5" : "border-gray-100 hover:border-gray-200"}`}>
                  <input
                    type="radio"
                    name="reviewerId"
                    value={r.id}
